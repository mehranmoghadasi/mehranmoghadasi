...
<a href="https://github.com/mehranmoghadasi">
  <img src="https://readme-typing-svg.demolab.com/?font=JetBrains+Mono&weight=600&size=30&duration=2800&pause=900&color=06B6D4&center=true&vCenter=true&width=900&height=80&lines=Digital+Marketing+Engineer;SEO+%26+Web+Performance+Specialist;Marketing+Automation+%2B+AI+Workflows;13+years.+30%2B+accounts.+1+toolkit." alt="role"/>
</a>
...
+
+ I build the tools agencies and in-house marketing teams actually use — SEO audit
+ frameworks, Google Ads ROAS calculators, WordPress performance toolkits, and
+ AI-augmented automation that turns repetitive marketing work into one-line scripts.
+
+ 13 years across 30+ accounts. Edmonton, AB · Open to Senior / Manager / Marketing-Engineering roles.
```
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Crawl-aware audit frameworks, JSON-LD schema generators, structured-data validators, sitemap analyzers, redirect-chain hunters, and keyword-clustering pipelines built on Jaccard / cosine similarity. Tooling for agencies that need answers, not dashboards.</p>
      <p><sub><b>Stack:</b> Python · BeautifulSoup · pandas · scikit-learn · Pydantic</sub></p>
    </td>
    <td width="50%" valign="top">
      <h3>🎯 &nbsp;Paid Media &amp; Analytics</h3>
      <p>Google Ads ROAS calculators, negative-keyword miners, GA4/GTM tagging utilities, conversion-tracking validators, and budget-pacing models. Systems that connect the spreadsheet logic in a media planner's head to executable code.</p>
      <p><sub><b>Stack:</b> Python · Google Ads API · GA4 Data API · GTM Server-Side</sub></p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3>🧱 &nbsp;WordPress at Scale</h3>
      <p>Conversion-optimized starter themes, performance-tuning toolkits, MU-plugin patterns, and lead-generation infrastructure for service businesses. Built for sites that need to load fast and convert harder.</p>
      <p><sub><b>Stack:</b> PHP · WordPress · ACF · Tailwind · .htaccess</sub></p>
    </td>
    <td width="50%" valign="top">
      <h3>🤖 &nbsp;AI-Augmented Marketing</h3>
      <p>Prompt engines for content briefs, LLM-powered keyword expansion, AI-assisted ad-copy variants with brand-voice guards, and reporting agents that turn raw GA4 / Search Console data into exec-ready summaries.</p>
      <p><sub><b>Stack:</b> Python · OpenAI / Anthropic APIs · LangChain · n8n</sub></p>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td>🇨🇦</td>
    <td><b>Canadian roles</b> — Edmonton, Calgary, Vancouver, Toronto. On-site, hybrid, or remote.</td>
  </tr>
  <tr>
    <td>🎯</td>
    <td><b>Senior Digital Marketing Manager</b> · Marketing Technologist · SEO Lead · WordPress Engineer · MarTech roles at agencies, in-house teams, or SaaS.</td>
  </tr>
  <tr>
    <td>🛠</td>
    <td><b>Contract / freelance</b> — SEO audits, performance overhauls, custom marketing tooling, GA4/GTM implementations.</td>
  </tr>
  <tr>
    <td>🤝</td>
    <td><b>Open-source collaboration</b> on marketing engineering, SEO automation, or WordPress performance tooling.</td>
  </tr>
</table>
...
<sub>⌁ Crafted with intent · last updated <code>2026-05-09</code> ⌁</sub>
